...
SimpleShader.prototype.activateShader = function (pixelColor, aCamera, isCircle) {
    var gl = gEngine.Core.getGL();
    gl.useProgram(this.mCompiledShader);
    gl.uniformMatrix4fv(this.mViewProjTransform, false, aCamera.getVPMatrix());
    gl.bindBuffer(gl.ARRAY_BUFFER, isCircle === null || isCircle === false
        ? gEngine.VertexBuffer.getGLVertexRef() : gEngine.VertexBuffer.getGLCircleVertexRef());
