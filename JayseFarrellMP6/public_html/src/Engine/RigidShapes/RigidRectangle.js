...
RigidRectangle.prototype.checkRectCirc = function(otherShape, collisionInfo){
    ...
    if(inside){
        ...
        collisionInfo.setInfo(otherShape.mRadius - bestDistance, vec2.negate(vec2.create(), this.mFaceNormal[nearestEdge]),
        ...
        if(dot < 0) { //region 1
            ...
            collisionInfo.setInfo(otherShape.mRadius - dis, vec2.negate(vec2.create(), normal),
            ...
            if(dot < 0){//region 2
                ...
                collisionInfo.setInfo(otherShape.mRadius - dis, vec2.negate(vec2.create(), normal),
                    ...
                    if(bestDistance < otherShape.mRadius){
                        ...
                        collisionInfo.setInfo(depth, vec2.negate(vec2.create(), this.mFaceNormal[nearestEdge]),
                        vec2.subtract(vec2.create(), circ2Pos, radiusVec));
                    }
                else
                        return false;
