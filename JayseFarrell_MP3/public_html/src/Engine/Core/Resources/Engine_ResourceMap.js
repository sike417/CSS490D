...
gEngine.ResourceMap = (function () {
    ...
    */
    ...
    var retrieveImageDimensions = function(rName){
        var r = null;
        if (rName in mResourceMap) {
            r = [mResourceMap[rName].mAsset.mWidth, mResourceMap[rName].mAsset.mHeight];
        } else {
            alert("gEngine.retrieveAsset: [" + rName + "] not in map!");
        }
        return r; 
    ...
    var mPublic = {
        ...
        retrieveImageDimensions: retrieveImageDimensions,
