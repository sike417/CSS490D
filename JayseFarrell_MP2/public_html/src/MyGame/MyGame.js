...
MyGame.prototype.unloadScene = function() {
    ...
    var nextLevel = (gEngine.Core.DefaultResources.state() === true) ? new BlueLevel() : new GrayLevel();  // next level to be loaded
    gEngine.DefaultResources.updateState();
...
MyGame.prototype.initialize = function () {
    ...
    var nextLevel = (gEngine.GameLoop.state() === true) ? new BlueLevel() : new GrayLevel();  // next level to be loaded
    gEngine.GameLoop.updateState();
    gEngine.Core.startScene(nextLevel);
    nextLevel.draw();
};
